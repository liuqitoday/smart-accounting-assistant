...
public record AggregateResult(String title, AnalysisMetric metric, AnalysisUnit unit,
    ...
    public record Values(BigDecimal value, long count) {}

    @Override
    @JsonProperty("kind")
    public AnalysisResultKind kind() { return AnalysisResultKind.AGGREGATE; }
}
